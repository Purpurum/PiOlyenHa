...
Это приложение должно повысить удобство и скорость обработки изображений, получаемых с автоматических фотоловушек, работая в автономном режиме на машине оператора, т.е. без доступа к интернету. 
</p>
...
#### Установка 
<p>
  Если вы решили попробовать нескомпилированное приложение, то вам необходимо:
  1. Установить Python версии не меньше 3.9
  2. В cmd pip install -r requirements.txt
  3. Запустить PingApp.py
</p>
